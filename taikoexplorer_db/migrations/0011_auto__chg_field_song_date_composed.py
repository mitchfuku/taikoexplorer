...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Song.date_composed'
        db.alter_column(u'taikoexplorer_db_song', 'date_composed', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Song.date_composed'
        db.alter_column(u'taikoexplorer_db_song', 'date_composed', self.gf('django.db.models.fields.DateField')(default=None))
