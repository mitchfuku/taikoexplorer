...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Group.date_founded'
        db.alter_column(u'taikoexplorer_db_group', 'date_founded', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Group.date_founded'
        db.alter_column(u'taikoexplorer_db_group', 'date_founded', self.gf('django.db.models.fields.DateField')(default=None))
