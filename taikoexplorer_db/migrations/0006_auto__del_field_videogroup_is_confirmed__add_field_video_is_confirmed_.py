...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoGroup.is_confirmed'
        db.delete_column('taikoexplorer_db_video_groups', 'is_confirmed')

        # Adding field 'Video.is_confirmed'
        db.add_column('taikoexplorer_db_video', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ComposerSong.is_confirmed'
        db.delete_column('taikoexplorer_db_composersong', 'is_confirmed')

        # Deleting field 'VideoSong.is_confirmed'
        db.delete_column('taikoexplorer_db_video_songs', 'is_confirmed')

        # Deleting field 'Song.is_confirmed'
        db.delete_column('taikoexplorer_db_song', 'is_confirmed')


    def backwards(self, orm):
        # Adding field 'VideoGroup.is_confirmed'
        db.add_column('taikoexplorer_db_video_groups', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Video.is_confirmed'
        db.delete_column('taikoexplorer_db_video', 'is_confirmed')

        # Adding field 'ComposerSong.is_confirmed'
        db.add_column('taikoexplorer_db_composersong', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VideoSong.is_confirmed'
        db.add_column('taikoexplorer_db_video_songs', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Song.is_confirmed'
        db.add_column('taikoexplorer_db_song', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
