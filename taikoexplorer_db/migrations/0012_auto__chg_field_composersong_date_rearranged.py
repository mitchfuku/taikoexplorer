...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComposerSong.date_rearranged'
        db.alter_column(u'taikoexplorer_db_composersong', 'date_rearranged', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ComposerSong.date_rearranged'
        db.alter_column(u'taikoexplorer_db_composersong', 'date_rearranged', self.gf('django.db.models.fields.DateField')(default=None))
